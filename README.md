...
scripts. É possivel fazer um seach dos produtos exibidos na pagina de duas formas: Utilizando a `barra de pesquisa` e clicando em `search` para realizar a 
filtragem por nome do produto ou o `quick find` escolhendo uma categoria e uma faixa de preço. Os produtos da sessão 
de `most reviewed items são os itens com mais avaliações DA API MAS NÃO SÃO FILTRAVEIS`. Para rodar o app basta abrir o arquivo do index normalmente 
